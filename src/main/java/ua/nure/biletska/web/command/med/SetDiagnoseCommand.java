...
public class SetDiagnoseCommand extends Command {
    ...
    public String execute(HttpServletRequest request, HttpServletResponse response)
        ...
        int diagnose_id = Integer.parseInt(request.getParameter("diagnose_name"));
        new PatientDAO().Set_diagnos(diagnose_id, patient_id);
